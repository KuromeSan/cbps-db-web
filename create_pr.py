...
LOGIN_USERNAME = "CsvUpdater"
LOGIN_PASSWORD = "Qr3;2thY@6B#tfw*"
...
pullRequestPageRequest = githubSession.get('https://github.com/KuromeSan/cbps-db/pull/new/'+MERGE_WITH_MASTER,headers=header)
